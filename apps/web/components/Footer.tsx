...
const Footer = () => {
  return (
    <footer className="bg-museum-darker museum-edge-top pt-16 pb-8 text-white/70 font-body">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><Link href="/museo" className="hover:text-museum-accent transition-colors">Il Museo</Link></li>
              <li><Link href="/pau" className="hover:text-museum-accent transition-colors">PAU - Città Museo</Link></li>
              <li><Link href="/itinerari" className="hover:text-museum-accent transition-colors">Itinerari</Link></li>
              <li><Link href="/collezioni" className="hover:text-museum-accent transition-colors">Collezioni</Link></li>
              <li><Link href="/museo/contatti" className="hover:text-museum-accent transition-colors">Orari e Biglietti</Link></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-xs">
          ...
          <div className="flex gap-6">
            ...
            <Link href="#" className="hover:text-white transition-colors">Accessibilità</Link>
          </div>
        </div>
      </div>
    </footer>
